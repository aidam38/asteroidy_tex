...
Rozdělení planetek na hlavní pás, Trojany, Hildy, \ldots
...
\begin{figure}[!htb]
	...
	\caption{Závislost počtu členů rodiny Eunomia na zvolení hraniční rychlost $v_{cutoff}$. Počet členů prudce vzroste při přechodu z rychlosti $43\,{\rm m/s}$ na $44\,{\rm m/s}$, což je způsobené vzdáleností prvního tělesa jiného než mateřského tělesa. Dále vzroste prudce při přechodu z rychlosti $46\,{\rm m/s}$ na $47\,{\rm m/s}$, což je způsobené splynutím s jinou rodinou.}
	\label{Nv}
\end{figure}
\begin{figure}[!htb]
	\centering
